...
float: right;
font-size: 16px;"> {{Auth::user()->username }} -- Last access : 30 May 2014 &nbsp; <a style="border-radius:5px;" href="/admin/logout" class="btn btn-danger square-btn-adjust">Logout</a>
 </div>
        </nav>   
           <!-- /. NAV TOP  -->
 @yield('sidebar')
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src={{ asset("assets/img/1.png") }} alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src={{ asset("assets/img/2.png") }} alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src={{ asset("assets/img/3.png") }} alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src={{ asset("assets/img/4.png") }} alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
